...
public class EntityCreateRequestHandler<TSource, TViewModel, TKey> : IHttpRequestHandler
where TViewModel : class
where TSource : class
{
    private readonly EntityMetadata<TSource, TViewModel, TKey> _entityMetadata;

    public EntityCreateRequestHandler(EntityMetadata<TSource, TViewModel, TKey> entityMetadata)
    {
